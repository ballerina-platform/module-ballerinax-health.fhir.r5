...
public const string PROFILE_BASE_LOGICLIBRARY = "http://hl7.org/fhir/StructureDefinition/logiclibrary";
public const RESOURCE_NAME_LOGICLIBRARY = "Library";
...
# 1) LogicLibraryRelatedArtifactDependency: Additional documentation, citations, etc
#       - min = 0
#       - max = *
#
...
@r5:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/StructureDefinition/logiclibrary",
    elements: {
        "date" : {
            name: "date",
...
public type LogicLibrary record {|
    *r5:DomainResource;

    RESOURCE_NAME_LOGICLIBRARY resourceType = RESOURCE_NAME_LOGICLIBRARY;
    ...
    r5:code language?;
    string title;
    LogicLibraryType 'type;
    LogicLibraryContent[] content?;
    ...
    LogicLibraryStatus status;
    r5:Element ...;
|};

# FHIR LogicLibraryRelatedArtifactDependency datatype record.
#
...
@r5:DataTypeDefinition {
    name: "LogicLibraryRelatedArtifactDependency",
    baseType: (),
    elements: {
        "publicationStatus": {
            name: "publicationStatus",
            dataType: LogicLibraryRelatedArtifactPublicationStatus,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: LogicLibraryRelatedArtifactType,
            min: 1,
            max: 1,
            isArray: false,
...
public type LogicLibraryRelatedArtifactDependency record {|
    *r5:RelatedArtifact;

    LogicLibraryRelatedArtifactPublicationStatus publicationStatus?;
    r5:Extension[] extension?;
    ...
    string id?;
    string label?;
    LogicLibraryRelatedArtifactType 'type = "depends-on";
    r5:date publicationDate?;
    r5:Reference resourceReference?;
|};

# LogicLibraryRelatedArtifactPublicationStatus enum
public enum LogicLibraryRelatedArtifactPublicationStatus {
...
# FHIR LogicLibraryType datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r5:DataTypeDefinition {
    name: "LogicLibraryType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: LogicLibraryTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type LogicLibraryType record {|
    *r5:CodeableConcept;
    ...
    LogicLibraryTypeCoding[] coding;
|};

# FHIR LogicLibraryTypeCoding datatype record.
#
...
public type LogicLibraryTypeCoding record {|
    *r5:Coding;
...
public enum LogicLibraryStatus {
...
public type LogicLibraryContent record {|
    *r5:Attachment;
...
public enum LogicLibraryRelatedArtifactType {
