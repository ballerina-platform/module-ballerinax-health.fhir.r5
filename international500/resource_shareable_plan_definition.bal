...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "actor" : {
            name: "actor",
            dataType: ShareablePlanDefinitionActor,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ShareablePlanDefinition record {|
    *r5:DomainResource;
    ...
    r5:uri url;
    ShareablePlanDefinitionActor[] actor?;
...
# FHIR ShareablePlanDefinitionActionOutput datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r5:DataTypeDefinition {
    name: "ShareablePlanDefinitionActionOutput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ShareablePlanDefinitionActionOutput record {|
    *r5:BackboneElement;
...
# FHIR ShareablePlanDefinitionActor datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r5:DataTypeDefinition {
    name: "ShareablePlanDefinitionActor",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "option": {
            name: "option",
            dataType: ShareablePlanDefinitionActorOption,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ShareablePlanDefinitionActor record {|
    *r5:BackboneElement;
    ...
    ShareablePlanDefinitionActorOption[] option;
|};

# ShareablePlanDefinitionActionRelatedActionEndRelationship enum
public enum ShareablePlanDefinitionActionRelatedActionEndRelationship {
...
# FHIR ShareablePlanDefinitionActorOption datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ShareablePlanDefinitionActorOption",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: ShareablePlanDefinitionActorOptionType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type ShareablePlanDefinitionActorOption record {|
    *r5:BackboneElement;
    ...
    string id?;
    ShareablePlanDefinitionActorOptionType 'type?;
|};
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "endRelationship": {
            ...
            dataType: ShareablePlanDefinitionActionRelatedActionEndRelationship,
            min: 0,
            max: 1,
            isArray: false,
...
public type ShareablePlanDefinitionActionRelatedAction record {|
    *r5:BackboneElement;
    ...
    r5:id targetId;
    r5:Extension[] modifierExtension?;
    ShareablePlanDefinitionActionRelatedActionEndRelationship endRelationship?;
    string id?;
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "output": {
            name: "output",
            dataType: ShareablePlanDefinitionActionOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "input": {
            name: "input",
            dataType: ShareablePlanDefinitionActionInput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ShareablePlanDefinitionAction record {|
    *r5:BackboneElement;
    ...
    ShareablePlanDefinitionActionOutput[] output?;
    ...
    r5:Reference subjectReference?;
    ShareablePlanDefinitionActionInput[] input?;
...
public enum ShareablePlanDefinitionActorOptionType {
   CODE_TYPE_CARETEAM = "careteam",
   CODE_TYPE_PRACTITIONER = "practitioner",
   CODE_TYPE_PRACTITIONERROLE = "practitionerrole",
   CODE_TYPE_PATIENT = "patient",
...
# FHIR ShareablePlanDefinitionActionInput datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
# + title - A human-readable label for the data requirement used to label data flows in BPMN or similar diagrams. Also provides a human readable label when rendering the data requirement that conveys its purpose to human readers.
@r5:DataTypeDefinition {
    name: "ShareablePlanDefinitionActionInput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ShareablePlanDefinitionActionInput record {|
    *r5:BackboneElement;
