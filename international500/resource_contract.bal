...
public type Contract record {|
    *r5:DomainResource;
    ...
    r5:Reference topicReference?;
    ContractContentDefinition contentDefinition?;
    r5:CodeableConcept scope?;
    ContractLegal[] legal?;
    string[] alias?;
    ContractTerm[] term?;
    string id?;
    r5:Narrative text?;
    r5:dateTime issued?;
    r5:CodeableConcept contentDerivative?;
    ContractSigner[] signer?;
    r5:Identifier[] identifier?;
    r5:CodeableConcept expirationType?;
    r5:Attachment legallyBindingAttachment?;
    r5:Reference author?;
    r5:CodeableConcept topicCodeableConcept?;
    r5:Reference instantiatesCanonical?;
    string 'version?;
    r5:uri url?;
    ...
    r5:CodeableConcept legalState?;
    r5:Reference legallyBindingReference?;
...
public type ContractTermAsset record {|
    *r5:BackboneElement;
    ...
    r5:Period[] usePeriod?;
    r5:Extension[] modifierExtension?;
    r5:unsignedInt[] securityLabelNumber?;
    r5:CodeableConcept[] 'type?;
    string condition?;
    string[] linkId?;
    r5:CodeableConcept[] periodType?;
    r5:CodeableConcept[] subtype?;
    r5:CodeableConcept scope?;
...
public type ContractTermOffer record {|
    *r5:BackboneElement;
    ...
    r5:CodeableConcept[] decisionMode?;
    r5:Reference topic?;
    string id?;
    string text?;
...
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + valueContractCoding - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractInteger - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractBoolean - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + valueContractUri - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractDate - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractAttachment - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractTime - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + valueContractDecimal - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractDateTime - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractString - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractQuantity - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
# + valueContractReference - Response to an offer clause or question text, which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warranty duration, or whether biospecimen may be used for further research.
@r5:DataTypeDefinition {
...
public type ContractTermOfferAnswer record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] extension?;
    r5:Coding valueContractCoding;
    r5:integer valueContractInteger;
    boolean valueContractBoolean;
    r5:Extension[] modifierExtension?;
    r5:uri valueContractUri;
    r5:date valueContractDate;
    r5:Attachment valueContractAttachment;
    r5:time valueContractTime;
    string id?;
    decimal valueContractDecimal;
    r5:dateTime valueContractDateTime;
    string valueContractString;
    r5:Quantity valueContractQuantity;
    r5:Reference valueContractReference;
|};
...
public type ContractTermAssetValuedItem record {|
    *r5:BackboneElement;
    ...
    r5:CodeableConcept entityContractCodeableConcept?;
    r5:dateTime effectiveTime?;
    r5:Extension[] modifierExtension?;
    r5:unsignedInt[] securityLabelNumber?;
    decimal points?;
    string[] linkId?;
    ...
    decimal factor?;
    r5:Money net?;
    r5:dateTime paymentDate?;
    r5:Reference entityContractReference?;
|};
...
public type ContractTermAction record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    r5:CodeableConcept performerRole?;
    r5:dateTime occurrenceContractDateTime?;
    string[] performerLinkId?;
    r5:unsignedInt[] securityLabelNumber?;
    r5:CodeableConcept 'type;
    string[] contextLinkId?;
    r5:CodeableConcept intent;
    r5:CodeableConcept[] performerType?;
    string[] requesterLinkId?;
    r5:Period occurrenceContractPeriod?;
    string[] linkId?;
    r5:Timing occurrenceContractTiming?;
