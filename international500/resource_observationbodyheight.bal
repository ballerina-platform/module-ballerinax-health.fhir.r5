...
public const string PROFILE_BASE_OBSERVATIONBODYHEIGHT = "http://hl7.org/fhir/StructureDefinition/bodyheight";
public const RESOURCE_NAME_OBSERVATIONBODYHEIGHT = "Observation";

# FHIR Observationbodyheight resource record.
#
...
# * category Slicings
# 1) ObservationbodyheightCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: ObservationbodyheightValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationbodyheightReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationbodyheightStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationbodyheightCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationbodyheightComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationbodyheightTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationbodyheight record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONBODYHEIGHT resourceType = RESOURCE_NAME_OBSERVATIONBODYHEIGHT;
    ...
    r5:Reference device?;
    ObservationbodyheightStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationbodyheightCode code;
    ...
    ObservationbodyheightComponent[] component?;
    ...
    ObservationbodyheightTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# FHIR ObservationbodyheightReferenceRange datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyheightReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodyheightReferenceRange record {|
    *r5:BackboneElement;
...
public enum ObservationbodyheightValueComparator {
...
# FHIR ObservationbodyheightTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyheightTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationbodyheightTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationbodyheightTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationbodyheightTriggeredByType 'type;
|};

# ObservationbodyheightStatus enum
public enum ObservationbodyheightStatus {
...
# FHIR ObservationbodyheightCodeCodingBodyHeightCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbodyheightCodeCodingBodyHeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodyheightCodeCodingBodyHeightCode record {|
    *r5:Coding;
...
# FHIR ObservationbodyheightCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationbodyheightCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodyheightCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationbodyheightCategoryVSCat datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyheightCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationbodyheightCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationbodyheightCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationbodyheightCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR ObservationbodyheightComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyheightComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationbodyheightComponent record {|
    *r5:BackboneElement;
...
# FHIR ObservationbodyheightValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyheightValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationbodyheightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
# FHIR ObservationbodyheightCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationbodyheightCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type ObservationbodyheightCode record {|
    *r5:CodeableConcept;
...
public enum ObservationbodyheightTriggeredByType {
