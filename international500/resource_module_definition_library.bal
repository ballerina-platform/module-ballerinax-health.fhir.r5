...
public const string PROFILE_BASE_MODULEDEFINITIONLIBRARY = "http://hl7.org/fhir/StructureDefinition/moduledefinitionlibrary";
public const RESOURCE_NAME_MODULEDEFINITIONLIBRARY = "Library";

# FHIR ModuleDefinitionLibrary resource record.
#
...
# 1) ModuleDefinitionLibraryRelatedArtifactDependency: Additional documentation, citations, etc
#       - min = 0
#       - max = *
#
...
@r5:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/StructureDefinition/moduledefinitionlibrary",
    elements: {
        "date" : {
            name: "date",
        ...
        "type" : {
            name: "type",
            dataType: ModuleDefinitionLibraryType,
            min: 1,
            max: 1,
            isArray: false,
            path: "Library.type",
        ...
        "status" : {
            name: "status",
            dataType: ModuleDefinitionLibraryStatus,
            min: 1,
            max: 1,
            isArray: false,
            path: "Library.status",
...
public type ModuleDefinitionLibrary record {|
    *r5:DomainResource;

    RESOURCE_NAME_MODULEDEFINITIONLIBRARY resourceType = RESOURCE_NAME_MODULEDEFINITIONLIBRARY;
    ...
    r5:code language?;
    ModuleDefinitionLibraryType 'type;
    string title;
    ...
    ModuleDefinitionLibraryStatus status;
    r5:Element ...;
|};

# ModuleDefinitionLibraryRelatedArtifactType enum
public enum ModuleDefinitionLibraryRelatedArtifactType {
...
public enum ModuleDefinitionLibraryRelatedArtifactPublicationStatus {
...
public enum ModuleDefinitionLibraryStatus {
...
# FHIR ModuleDefinitionLibraryType datatype record.
#
# + coding - A reference to a code defined by a terminology system.
@r5:DataTypeDefinition {
    name: "ModuleDefinitionLibraryType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ModuleDefinitionLibraryTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ModuleDefinitionLibraryType record {|
    *r5:CodeableConcept;
    ...
    ModuleDefinitionLibraryTypeCoding[] coding;
|};

# FHIR ModuleDefinitionLibraryRelatedArtifactDependency datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ModuleDefinitionLibraryRelatedArtifactDependency",
    baseType: (),
    elements: {
        "publicationStatus": {
            name: "publicationStatus",
            dataType: ModuleDefinitionLibraryRelatedArtifactPublicationStatus,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: ModuleDefinitionLibraryRelatedArtifactType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ModuleDefinitionLibraryRelatedArtifactDependency record {|
    *r5:RelatedArtifact;

    ModuleDefinitionLibraryRelatedArtifactPublicationStatus publicationStatus?;
    r5:Extension[] extension?;
    ...
    string id?;
    string label?;
    ModuleDefinitionLibraryRelatedArtifactType 'type = "depends-on";
    r5:date publicationDate?;
    r5:Reference resourceReference?;
|};

# FHIR ModuleDefinitionLibraryTypeCoding datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ModuleDefinitionLibraryTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type ModuleDefinitionLibraryTypeCoding record {|
    *r5:Coding;

    r5:uri system = "http://terminology.hl7.org/CodeSystem/library-type";
    r5:code code = "logic-library";
|};
