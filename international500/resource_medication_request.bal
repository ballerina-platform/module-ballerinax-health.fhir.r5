...
public type MedicationRequest record {|
    *r5:DomainResource;
    ...
    r5:CodeableConcept courseOfTherapyType?;
    r5:Reference priorPrescription?;
...
public type MedicationRequestDispenseRequest record {|
    *r5:BackboneElement;
    ...
    r5:Reference dispenser?;
    r5:Annotation[] dispenserInstruction?;
    r5:Period validityPeriod?;
    r5:Duration dispenseInterval?;
    r5:Extension[] extension?;
    r5:Quantity quantity?;
    r5:unsignedInt numberOfRepeatsAllowed?;
    r5:Extension[] modifierExtension?;
    r5:CodeableConcept doseAdministrationAid?;
    MedicationRequestDispenseRequestInitialFill initialFill?;
    string id?;
    r5:Duration expectedSupplyDuration?;
|};
...
public type MedicationRequestSubstitution record {|
    *r5:BackboneElement;
    ...
    r5:CodeableConcept allowedCodeableConcept;
