...
public type Goal record {|
    *r5:DomainResource;
    ...
    string id?;
    r5:Narrative text?;
    r5:CodeableReference[] outcome?;
    r5:Identifier[] identifier?;
    r5:CodeableConcept priority?;
    GoalTarget[] target?;
    r5:Resource[] contained?;
    r5:CodeableConcept startCodeableConcept?;
    r5:Meta meta?;
    r5:uri implicitRules?;
    r5:CodeableConcept achievementStatus?;
...
public type GoalTarget record {|
    *r5:BackboneElement;
    ...
    r5:Range detailRange?;
    r5:Extension[] extension?;
    r5:Quantity detailQuantity?;
    r5:date dueDate?;
    r5:Extension[] modifierExtension?;
    string detailString?;
    boolean detailBoolean?;
    r5:Duration dueDuration?;
    r5:CodeableConcept measure?;
    r5:Ratio detailRatio?;
    r5:integer detailInteger?;
    r5:CodeableConcept detailCodeableConcept?;
    string id?;
|};
