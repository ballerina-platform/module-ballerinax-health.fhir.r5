...
public const string PROFILE_BASE_OBSERVATIONBODYWEIGHT = "http://hl7.org/fhir/StructureDefinition/bodyweight";
public const RESOURCE_NAME_OBSERVATIONBODYWEIGHT = "Observation";

# FHIR Observationbodyweight resource record.
#
...
# * category Slicings
# 1) ObservationbodyweightCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: ObservationbodyweightValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationbodyweightReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationbodyweightStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationbodyweightCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationbodyweightComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationbodyweightTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationbodyweight record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONBODYWEIGHT resourceType = RESOURCE_NAME_OBSERVATIONBODYWEIGHT;
    ...
    r5:Reference device?;
    ObservationbodyweightStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationbodyweightCode code;
    ...
    ObservationbodyweightComponent[] component?;
    ...
    ObservationbodyweightTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# ObservationbodyweightStatus enum
public enum ObservationbodyweightStatus {
...
# FHIR ObservationbodyweightCodeCodingBodyWeightCode datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyweightCodeCodingBodyWeightCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodyweightCodeCodingBodyWeightCode record {|
    *r5:Coding;

    r5:Extension[] extension?;
    r5:code code = "29463-7";
...
public enum ObservationbodyweightValueComparator {
...
# FHIR ObservationbodyweightTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyweightTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationbodyweightTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationbodyweightTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationbodyweightTriggeredByType 'type;
|};

# ObservationbodyweightTriggeredByType enum
public enum ObservationbodyweightTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationbodyweightComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyweightComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationbodyweightComponent record {|
    *r5:BackboneElement;
...
# FHIR ObservationbodyweightCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationbodyweightCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodyweightCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationbodyweightReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbodyweightReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodyweightReferenceRange record {|
    *r5:BackboneElement;
...
# FHIR ObservationbodyweightValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyweightValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationbodyweightValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
# FHIR ObservationbodyweightCategoryVSCat datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodyweightCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationbodyweightCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationbodyweightCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationbodyweightCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR ObservationbodyweightCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationbodyweightCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type ObservationbodyweightCode record {|
    *r5:CodeableConcept;
