...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "actor" : {
            name: "actor",
            dataType: CDSHooksServicePlanDefinitionActor,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CDSHooksServicePlanDefinition record {|
    *r5:DomainResource;
    ...
    string 'version?;
    r5:uri url?;
    CDSHooksServicePlanDefinitionActor[] actor?;
...
@r5:DataTypeDefinition {
    name: "CDSHooksServicePlanDefinitionActionOutput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type CDSHooksServicePlanDefinitionActionOutput record {|
    *r5:BackboneElement;
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "endRelationship": {
            ...
            dataType: CDSHooksServicePlanDefinitionActionRelatedActionEndRelationship,
            min: 0,
            max: 1,
            isArray: false,
...
public type CDSHooksServicePlanDefinitionActionRelatedAction record {|
    *r5:BackboneElement;
    ...
    r5:id targetId;
    r5:Extension[] modifierExtension?;
    CDSHooksServicePlanDefinitionActionRelatedActionEndRelationship endRelationship?;
    string id?;
...
@r5:DataTypeDefinition {
    name: "CDSHooksServicePlanDefinitionActorOption",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: CDSHooksServicePlanDefinitionActorOptionType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type CDSHooksServicePlanDefinitionActorOption record {|
    *r5:BackboneElement;
    ...
    string id?;
    CDSHooksServicePlanDefinitionActorOptionType 'type?;
|};
...
@r5:DataTypeDefinition {
    name: "CDSHooksServicePlanDefinitionActor",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "option": {
            name: "option",
            dataType: CDSHooksServicePlanDefinitionActorOption,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CDSHooksServicePlanDefinitionActor record {|
    *r5:BackboneElement;
    ...
    CDSHooksServicePlanDefinitionActorOption[] option;
|};
...
# + title - A human-readable label for the data requirement used to label data flows in BPMN or similar diagrams. Also provides a human readable label when rendering the data requirement that conveys its purpose to human readers.
@r5:DataTypeDefinition {
    name: "CDSHooksServicePlanDefinitionActionInput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type CDSHooksServicePlanDefinitionActionInput record {|
    *r5:BackboneElement;
...
public enum CDSHooksServicePlanDefinitionActorOptionType {
...
public enum CDSHooksServicePlanDefinitionActionRelatedActionEndRelationship {
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "output": {
            name: "output",
            dataType: CDSHooksServicePlanDefinitionActionOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "input": {
            name: "input",
            dataType: CDSHooksServicePlanDefinitionActionInput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type CDSHooksServicePlanDefinitionAction record {|
    *r5:BackboneElement;
    ...
    CDSHooksServicePlanDefinitionActionOutput[] output?;
    ...
    r5:Reference subjectReference?;
    CDSHooksServicePlanDefinitionActionInput[] input?;
