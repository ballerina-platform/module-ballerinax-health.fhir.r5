...
public const string PROFILE_BASE_PUBLISHABLENAMINGSYSTEM = "http://hl7.org/fhir/StructureDefinition/publishablenamingsystem";
public const RESOURCE_NAME_PUBLISHABLENAMINGSYSTEM = "NamingSystem";

# FHIR PublishableNamingSystem resource record.
#
...
@r5:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/StructureDefinition/publishablenamingsystem",
    elements: {
        "date" : {
            name: "date",
        ...
        "kind" : {
            name: "kind",
            dataType: PublishableNamingSystemKind,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "uniqueId" : {
            name: "uniqueId",
            dataType: PublishableNamingSystemUniqueId,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: PublishableNamingSystemStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type PublishableNamingSystem record {|
    *r5:DomainResource;

    RESOURCE_NAME_PUBLISHABLENAMINGSYSTEM resourceType = RESOURCE_NAME_PUBLISHABLENAMINGSYSTEM;
    ...
    PublishableNamingSystemKind kind;
    ...
    PublishableNamingSystemUniqueId[] uniqueId;
    PublishableNamingSystemStatus status;
    r5:Element ...;
|};

# PublishableNamingSystemUniqueIdType enum
public enum PublishableNamingSystemUniqueIdType {
...
public enum PublishableNamingSystemKind {
...
public enum PublishableNamingSystemStatus {
...
# FHIR PublishableNamingSystemUniqueId datatype record.
#
...
@r5:DataTypeDefinition {
    name: "PublishableNamingSystemUniqueId",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: PublishableNamingSystemUniqueIdType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PublishableNamingSystemUniqueId record {|
    *r5:BackboneElement;
    ...
    string comment?;
    string id?;
    PublishableNamingSystemUniqueIdType 'type;
    string value;
    boolean preferred?;
|};
