...
public const string PROFILE_BASE_OBSERVATIONHEARTRATE = "http://hl7.org/fhir/StructureDefinition/heartrate";
public const RESOURCE_NAME_OBSERVATIONHEARTRATE = "Observation";

# FHIR Observationheartrate resource record.
#
...
# * category Slicings
# 1) ObservationheartrateCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: ObservationheartrateValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationheartrateReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationheartrateStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationheartrateCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationheartrateComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationheartrateTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationheartrate record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONHEARTRATE resourceType = RESOURCE_NAME_OBSERVATIONHEARTRATE;
    ...
    r5:Reference device?;
    ObservationheartrateStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationheartrateCode code;
    ...
    ObservationheartrateComponent[] component?;
    ...
    ObservationheartrateTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# ObservationheartrateValueComparator enum
public enum ObservationheartrateValueComparator {
...
public enum ObservationheartrateTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationheartrateCode datatype record.
#
...
public type ObservationheartrateCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationheartrateComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationheartrateComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationheartrateComponent record {|
    *r5:BackboneElement;
...
public enum ObservationheartrateStatus {
...
# FHIR ObservationheartrateCodeCodingHeartRateCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationheartrateCodeCodingHeartRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationheartrateCodeCodingHeartRateCode record {|
    *r5:Coding;
...
# FHIR ObservationheartrateCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationheartrateCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationheartrateCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationheartrateReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationheartrateReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationheartrateReferenceRange record {|
    *r5:BackboneElement;
...
# FHIR ObservationheartrateCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationheartrateCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationheartrateCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type ObservationheartrateCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationheartrateCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR ObservationheartrateTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationheartrateTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationheartrateTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationheartrateTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationheartrateTriggeredByType 'type;
|};

# FHIR ObservationheartrateValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationheartrateValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationheartrateValueComparator,
            min: 0,
            max: 1,
            isArray: false,
