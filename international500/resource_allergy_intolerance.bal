...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "participant" : {
            name: "participant",
            dataType: AllergyIntoleranceParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AllergyIntolerance record {|
    *r5:DomainResource;
    ...
    string onsetString?;
    r5:Age onsetAge?;
    AllergyIntoleranceParticipant[] participant?;
    r5:dateTime lastOccurrence?;
...
public type AllergyIntoleranceReaction record {|
    *r5:BackboneElement;
    ...
    string id?;
    r5:dateTime onset?;
    r5:CodeableConcept exposureRoute?;
|};
...
public type AllergyIntoleranceParticipant record {|
    *r5:BackboneElement;
