...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observation record {|
    *r5:DomainResource;
    ...
    ObservationTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# ObservationTriggeredByType enum
public enum ObservationTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: ObservationTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationTriggeredBy record {|
    *r5:BackboneElement;
