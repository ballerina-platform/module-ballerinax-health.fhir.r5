...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "recurring" : {
            ...
            max: 1,
            isArray: false,
            path: "AppointmentResponse.recurring"
        },
        "modifierExtension" : {
        ...
        "recurrenceId" : {
            ...
            max: 1,
            isArray: false,
            path: "AppointmentResponse.recurrenceId"
        },
        "actor" : {
            name: "actor",
            dataType: r5:Reference,
        ...
        "proposedNewTime" : {
            ...
            max: 1,
            isArray: false,
            path: "AppointmentResponse.proposedNewTime"
        }
    },
    serializers: {
...
public type AppointmentResponse record {|
    *r5:DomainResource;
    ...
    r5:CodeableConcept[] participantType?;
    r5:instant 'start?;
...
public enum AppointmentResponseParticipantStatus {
   ...
   CODE_PARTICIPANTSTATUS_ENTERED_IN_ERROR = "entered-in-error"
}
