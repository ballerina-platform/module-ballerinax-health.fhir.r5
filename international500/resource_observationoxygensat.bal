...
public const string PROFILE_BASE_OBSERVATIONOXYGENSAT = "http://hl7.org/fhir/StructureDefinition/oxygensat";
public const RESOURCE_NAME_OBSERVATIONOXYGENSAT = "Observation";

# FHIR Observationoxygensat resource record.
#
...
# * category Slicings
# 1) ObservationoxygensatCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: ObservationoxygensatValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationoxygensatReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationoxygensatStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationoxygensatCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationoxygensatComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationoxygensatTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationoxygensat record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONOXYGENSAT resourceType = RESOURCE_NAME_OBSERVATIONOXYGENSAT;
    ...
    r5:Reference device?;
    ObservationoxygensatStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationoxygensatCode code;
    ...
    ObservationoxygensatComponent[] component?;
    ...
    ObservationoxygensatTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# ObservationoxygensatValueComparator enum
public enum ObservationoxygensatValueComparator {
...
# FHIR ObservationoxygensatCodeCodingOxygenSatCode datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationoxygensatCodeCodingOxygenSatCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationoxygensatCodeCodingOxygenSatCode record {|
    *r5:Coding;
...
public enum ObservationoxygensatTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationoxygensatComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationoxygensatComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationoxygensatComponent record {|
    *r5:BackboneElement;
...
# FHIR ObservationoxygensatCode datatype record.
#
...
public type ObservationoxygensatCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationoxygensatValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationoxygensatValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationoxygensatValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
# FHIR ObservationoxygensatCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationoxygensatCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationoxygensatCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationoxygensatReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationoxygensatReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationoxygensatReferenceRange record {|
    *r5:BackboneElement;
...
# FHIR ObservationoxygensatCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationoxygensatCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationoxygensatCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type ObservationoxygensatCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationoxygensatCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum ObservationoxygensatStatus {
...
# FHIR ObservationoxygensatTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationoxygensatTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationoxygensatTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationoxygensatTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationoxygensatTriggeredByType 'type;
|};
