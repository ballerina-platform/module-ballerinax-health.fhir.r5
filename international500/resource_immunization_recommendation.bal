...
public type ImmunizationRecommendation record {|
    *r5:DomainResource;
    ...
    @constraint:Array {
        ...
        maxLength: {
            value: 1,
            message: "Validation failed for $.ImmunizationRecommendation.recommendation constraint. This field must be an array containing at most one item."
        }
    }
...
public type ImmunizationRecommendationRecommendation record {|
    *r5:BackboneElement;
    ...
    r5:Reference[] supportingImmunization?;
    r5:Extension[] extension?;
    r5:CodeableConcept[] forecastReason?;
    r5:Extension[] modifierExtension?;
    r5:CodeableConcept forecastStatus;
    r5:markdown description?;
    r5:Reference[] supportingPatientInformation?;
    string doseNumber?;
    string seriesDoses?;
    r5:CodeableConcept[] contraindicatedVaccineCode?;
    string series?;
