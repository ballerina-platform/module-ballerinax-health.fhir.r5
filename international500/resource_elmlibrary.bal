...
public const string PROFILE_BASE_ELMLIBRARY = "http://hl7.org/fhir/StructureDefinition/elmlibrary";
public const RESOURCE_NAME_ELMLIBRARY = "Library";
...
# * content Slicings
# 1) ELMLibraryContentElmJsonContent: ELM JSON Content
#       - min = 0
#       - max = *
#
# 2) ELMLibraryContentElmXmlContent: ELM XML Content
#       - min = 0
#       - max = *
#
...
# 1) ELMLibraryRelatedArtifactDependency: Additional documentation, citations, etc
#       - min = 0
#       - max = *
#
...
@r5:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/StructureDefinition/elmlibrary",
    elements: {
        "date" : {
            name: "date",
...
public type ELMLibrary record {|
    *r5:DomainResource;

    RESOURCE_NAME_ELMLIBRARY resourceType = RESOURCE_NAME_ELMLIBRARY;
...
public type ELMLibraryType record {|
    *r5:CodeableConcept;
    ...
    ELMLibraryTypeCoding[] coding;
|};

# ELMLibraryStatus enum
public enum ELMLibraryStatus {
...
@r5:DataTypeDefinition {
    name: "ELMLibraryRelatedArtifactDependency",
    baseType: (),
    elements: {
        "publicationStatus": {
            name: "publicationStatus",
            dataType: ELMLibraryRelatedArtifactPublicationStatus,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: ELMLibraryRelatedArtifactType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ELMLibraryRelatedArtifactDependency record {|
    *r5:RelatedArtifact;

    ELMLibraryRelatedArtifactPublicationStatus publicationStatus?;
    r5:Extension[] extension?;
    ...
    string id?;
    string label?;
    ELMLibraryRelatedArtifactType 'type = "depends-on";
...
public type ELMLibraryTypeCoding record {|
    *r5:Coding;
...
public enum ELMLibraryRelatedArtifactPublicationStatus {
...
@r5:DataTypeDefinition {
    name: "ELMLibraryContentElmXmlContent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ELMLibraryContentElmXmlContent record {|
    *ELMLibraryContent;
    ...
    string id?;
    r5:code contentType = "application/elm+xml";
...
# + height - Height of the image in pixels (photo/video).
@r5:DataTypeDefinition {
    name: "ELMLibraryContentElmJsonContent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ELMLibraryContentElmJsonContent record {|
    *ELMLibraryContent;
    ...
    r5:positiveInt width?;
    string id?;
    r5:code contentType = "application/elm+json";
    r5:dateTime creation?;
    r5:base64Binary hash?;
    r5:positiveInt height?;
|};
...
public type ELMLibraryContent record {|
    *r5:Attachment;
...
public enum ELMLibraryRelatedArtifactType {
