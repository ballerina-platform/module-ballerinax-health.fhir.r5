...
public const string PROFILE_BASE_OBSERVATIONVITALSPANEL = "http://hl7.org/fhir/StructureDefinition/vitalspanel";
public const RESOURCE_NAME_OBSERVATIONVITALSPANEL = "Observation";

# FHIR Observationvitalspanel resource record.
#
...
# * category Slicings
# 1) ObservationvitalspanelCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationvitalspanelReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationvitalspanelStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationvitalspanelCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationvitalspanelComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationvitalspanelTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationvitalspanel record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONVITALSPANEL resourceType = RESOURCE_NAME_OBSERVATIONVITALSPANEL;
    ...
    ObservationvitalspanelReferenceRange[] referenceRange?;
    ...
    r5:Reference device?;
    ObservationvitalspanelStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationvitalspanelCode code;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.Observation.hasMember constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.Observation.hasMember constraint. This field must be an array containing at most one item."
        }
    }
    r5:Reference[] hasMember;
    r5:Reference encounter?;
    r5:CodeableConcept bodySite?;
    ObservationvitalspanelComponent[] component?;
    ...
    ObservationvitalspanelTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# FHIR ObservationvitalspanelCategoryCoding datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationvitalspanelCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationvitalspanelCode datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type ObservationvitalspanelCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationvitalspanelCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationvitalspanelCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type ObservationvitalspanelCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationvitalspanelCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum ObservationvitalspanelStatus {
...
# FHIR ObservationvitalspanelReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationvitalspanelReferenceRange record {|
    *r5:BackboneElement;
...
# FHIR ObservationvitalspanelCodeCodingVitalsPanelCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelCodeCodingVitalsPanelCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationvitalspanelCodeCodingVitalsPanelCode record {|
    *r5:Coding;

    r5:Extension[] extension?;
    r5:code code = "85353-1";
...
public enum ObservationvitalspanelTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationvitalspanelTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationvitalspanelTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationvitalspanelTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationvitalspanelTriggeredByType 'type;
|};

# FHIR ObservationvitalspanelComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationvitalspanelComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationvitalspanelComponent record {|
    *r5:BackboneElement;
