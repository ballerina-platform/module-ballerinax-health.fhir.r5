...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "versionAlgorithmString" : {
            ...
            max: 1,
            isArray: false,
            path: "CapabilityStatement.versionAlgorithm[x]",
        ...
        "identifier" : {
            ...
            max: int:MAX_VALUE,
            isArray: true,
            path: "CapabilityStatement.identifier"
        },
        "rest" : {
            name: "rest",
        ...
        "acceptLanguage" : {
            ...
            max: int:MAX_VALUE,
            isArray: true,
            path: "CapabilityStatement.acceptLanguage",
            valueSet: "http://hl7.org/fhir/ValueSet/all-languages|5.0.0"
        },
        "copyrightLabel" : {
            name: "copyrightLabel",
            ...
            max: 1,
            isArray: false,
            path: "CapabilityStatement.copyrightLabel"
        },
        "meta" : {
            name: "meta",
            dataType: r5:Meta,
...
public type CapabilityStatement record {|
    *r5:DomainResource;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.CapabilityStatement.format constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.CapabilityStatement.format constraint. This field must be an array containing at most one item."
        }
    }
    ...
    r5:canonical[] implementationGuide?;
    r5:Resource[] contained?;
    r5:code[] acceptLanguage?;
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "conditionalPatch": {
            ...
            path: "CapabilityStatement.rest.resource.conditionalPatch"
        },
        "type": {
            name: "type",
            dataType: r5:code,
...
public enum CapabilityStatementRestResourceSearchParamType {
   ...
   CODE_TYPE_CAPABILTY_STATEMENT_QUANTITY = "quantity",
