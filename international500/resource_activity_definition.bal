...
public const string PROFILE_BASE_ACTIVITYDEFINITION = "http://hl7.org/fhir/StructureDefinition/ActivityDefinition";
public const RESOURCE_NAME_ACTIVITYDEFINITION = "ActivityDefinition";
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "participant" : {
            name: "participant",
            dataType: ActivityDefinitionParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority" : {
            name: "priority",
            dataType: ActivityDefinitionPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: ActivityDefinitionStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "dynamicValue" : {
            name: "dynamicValue",
            dataType: ActivityDefinitionDynamicValue,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "intent" : {
            name: "intent",
            dataType: ActivityDefinitionIntent,
            min: 0,
            max: 1,
            isArray: false,
...
public type ActivityDefinition record {|
    *r5:DomainResource;
...
public enum ActivityDefinitionParticipantType {
...
public enum ActivityDefinitionPriority {
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: ActivityDefinitionParticipantType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type ActivityDefinitionParticipant record {|
    *r5:BackboneElement;
    ...
    string id?;
    ActivityDefinitionParticipantType 'type?;
|};

# ActivityDefinitionIntent enum
public enum ActivityDefinitionIntent {
