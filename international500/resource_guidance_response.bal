...
public type GuidanceResponse record {|
    *r5:DomainResource;
    ...
    r5:CodeableConcept moduleCodeableConcept;
    r5:Reference[] result?;
    r5:Resource[] contained?;
    r5:Reference evaluationMessage?;
    r5:canonical moduleCanonical;
    r5:Meta meta?;
    r5:DataRequirement[] dataRequirement?;
    r5:uri implicitRules?;
    r5:dateTime occurrenceDateTime?;
    r5:Identifier requestIdentifier?;
    string id?;
    r5:Narrative text?;
    r5:uri moduleUri;
    r5:Reference outputParameters?;
