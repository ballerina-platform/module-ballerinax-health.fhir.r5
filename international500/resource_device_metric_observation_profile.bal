...
public const string PROFILE_BASE_DEVICEMETRICOBSERVATIONPROFILE = "http://hl7.org/fhir/StructureDefinition/devicemetricobservation";
public const RESOURCE_NAME_DEVICEMETRICOBSERVATIONPROFILE = "Observation";
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: DeviceMetricObservationProfileComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: DeviceMetricObservationProfileReferenceRange,
            min: 0,
            max: 1,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: DeviceMetricObservationProfileStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: DeviceMetricObservationProfileTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type DeviceMetricObservationProfile record {|
    *r5:DomainResource;

    RESOURCE_NAME_DEVICEMETRICOBSERVATIONPROFILE resourceType = RESOURCE_NAME_DEVICEMETRICOBSERVATIONPROFILE;
    ...
    DeviceMetricObservationProfileComponent[] component?;
    ...
    DeviceMetricObservationProfileReferenceRange[] referenceRange?;
    string valueString?;
    ...
    r5:Reference device;
    DeviceMetricObservationProfileStatus status;
    DeviceMetricObservationProfileTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};
...
@r5:DataTypeDefinition {
    name: "DeviceMetricObservationProfileComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type DeviceMetricObservationProfileComponent record {|
    *r5:BackboneElement;
...
@r5:DataTypeDefinition {
    name: "DeviceMetricObservationProfileReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type DeviceMetricObservationProfileReferenceRange record {|
    *r5:BackboneElement;
...
public enum DeviceMetricObservationProfileTriggeredByType {
...
public enum DeviceMetricObservationProfileStatus {
...
@r5:DataTypeDefinition {
    name: "DeviceMetricObservationProfileTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: DeviceMetricObservationProfileTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type DeviceMetricObservationProfileTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    DeviceMetricObservationProfileTriggeredByType 'type;
|};
