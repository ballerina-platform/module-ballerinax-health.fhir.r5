...
public const string PROFILE_BASE_CQLLIBRARY = "http://hl7.org/fhir/StructureDefinition/cqllibrary";
public const RESOURCE_NAME_CQLLIBRARY = "Library";
...
# * content Slicings
# 1) CQLLibraryContentCqlContent: CQL Content
#       - min = 1
#       - max = 1
#
...
# 1) CQLLibraryRelatedArtifactDependency: Additional documentation, citations, etc
#       - min = 0
#       - max = *
#
...
public type CQLLibrary record {|
    *r5:DomainResource;

    RESOURCE_NAME_CQLLIBRARY resourceType = RESOURCE_NAME_CQLLIBRARY;
    ...
    CQLLibraryStatus status;
    r5:Element ...;
|};

# CQLLibraryStatus enum
public enum CQLLibraryStatus {
...
public enum CQLLibraryRelatedArtifactPublicationStatus {
...
@r5:DataTypeDefinition {
    name: "CQLLibraryContentCqlContent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type CQLLibraryContentCqlContent record {|
    *CQLLibraryContent;
...
public type CQLLibraryContent record {|
    *r5:Attachment;
...
public type CQLLibraryType record {|
    *r5:CodeableConcept;
    ...
    CQLLibraryTypeCoding[] coding;
|};

# CQLLibraryRelatedArtifactType enum
public enum CQLLibraryRelatedArtifactType {
...
public type CQLLibraryTypeCoding record {|
    *r5:Coding;
...
@r5:DataTypeDefinition {
    name: "CQLLibraryRelatedArtifactDependency",
    baseType: (),
    elements: {
        "publicationStatus": {
            name: "publicationStatus",
            dataType: CQLLibraryRelatedArtifactPublicationStatus,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "type": {
            name: "type",
            dataType: CQLLibraryRelatedArtifactType,
            min: 1,
            max: 1,
            isArray: false,
...
public type CQLLibraryRelatedArtifactDependency record {|
    *r5:RelatedArtifact;

    CQLLibraryRelatedArtifactPublicationStatus publicationStatus?;
    r5:Extension[] extension?;
    ...
    string id?;
    string label?;
    CQLLibraryRelatedArtifactType 'type = "depends-on";
