...
public const string PROFILE_BASE_COMPUTABLEPLANDEFINITION = "http://hl7.org/fhir/StructureDefinition/computableplandefinition";
public const RESOURCE_NAME_COMPUTABLEPLANDEFINITION = "PlanDefinition";
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "action" : {
            name: "action",
            dataType: ComputablePlanDefinitionAction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "goal" : {
            name: "goal",
            dataType: ComputablePlanDefinitionGoal,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "actor" : {
            name: "actor",
            dataType: ComputablePlanDefinitionActor,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ComputablePlanDefinitionStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ComputablePlanDefinition record {|
    *r5:DomainResource;

    RESOURCE_NAME_COMPUTABLEPLANDEFINITION resourceType = RESOURCE_NAME_COMPUTABLEPLANDEFINITION;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.PlanDefinition.library constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.PlanDefinition.library constraint. This field must be an array containing at most one item."
        }
    }
    ...
    ComputablePlanDefinitionAction[] action?;
    ...
    ComputablePlanDefinitionGoal[] goal?;
    ...
    string 'version?;
    r5:uri url?;
    ComputablePlanDefinitionActor[] actor?;
    ...
    ComputablePlanDefinitionStatus status;
    r5:Element ...;
|};

# ComputablePlanDefinitionActionGroupingBehavior enum
public enum ComputablePlanDefinitionActionGroupingBehavior {
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActionCondition",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "kind": {
            name: "kind",
            dataType: ComputablePlanDefinitionActionConditionKind,
            min: 1,
            max: 1,
            isArray: false,
...
public type ComputablePlanDefinitionActionCondition record {|
    *r5:BackboneElement;

    r5:Extension[] extension?;
    r5:Expression expression?;
    ComputablePlanDefinitionActionConditionKind kind;
    r5:Extension[] modifierExtension?;
    string id?;
|};

# ComputablePlanDefinitionActorOptionType enum
public enum ComputablePlanDefinitionActorOptionType {
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActionParticipant",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: ComputablePlanDefinitionActionParticipantType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type ComputablePlanDefinitionActionParticipant record {|
    *r5:BackboneElement;
    ...
    string id?;
    ComputablePlanDefinitionActionParticipantType 'type?;
|};

# ComputablePlanDefinitionActionParticipantType enum
public enum ComputablePlanDefinitionActionParticipantType {
   CODE_TYPE_CARETEAM = "careteam",
   CODE_TYPE_PRACTITIONER = "practitioner",
   CODE_TYPE_PRACTITIONERROLE = "practitionerrole",
   CODE_TYPE_PATIENT = "patient",
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionAction",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "cardinalityBehavior": {
            ...
            dataType: ComputablePlanDefinitionActionCardinalityBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "participant": {
            name: "participant",
            dataType: ComputablePlanDefinitionActionParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "output": {
            name: "output",
            dataType: ComputablePlanDefinitionActionOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "dynamicValue": {
            name: "dynamicValue",
            dataType: ComputablePlanDefinitionActionDynamicValue,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "input": {
            name: "input",
            dataType: ComputablePlanDefinitionActionInput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "requiredBehavior": {
            ...
            dataType: ComputablePlanDefinitionActionRequiredBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "condition": {
            name: "condition",
            dataType: ComputablePlanDefinitionActionCondition,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "selectionBehavior": {
            ...
            dataType: ComputablePlanDefinitionActionSelectionBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "precheckBehavior": {
            ...
            dataType: ComputablePlanDefinitionActionPrecheckBehavior,
            min: 0,
            max: 1,
            isArray: false,
...
public type ComputablePlanDefinitionAction record {|
    *r5:BackboneElement;

    r5:CodeableConcept[] reason?;
    ComputablePlanDefinitionActionCardinalityBehavior cardinalityBehavior?;
    ...
    string title?;
    r5:CodeableConcept 'type?;
    ComputablePlanDefinitionActionGroupingBehavior groupingBehavior?;
    ComputablePlanDefinitionActionParticipant[] participant?;
    ComputablePlanDefinitionActionOutput[] output?;
    r5:canonical transform?;
    ComputablePlanDefinitionActionDynamicValue[] dynamicValue?;
    r5:Age timingAge?;
    string id?;
    ComputablePlanDefinitionActionRelatedAction[] relatedAction?;
    ...
    ComputablePlanDefinitionActionPriority priority?;
    r5:Reference subjectReference?;
    ComputablePlanDefinitionActionInput[] input?;
    ComputablePlanDefinitionActionRequiredBehavior requiredBehavior?;
    ComputablePlanDefinitionActionCondition[] condition?;
    string linkId?;
    ComputablePlanDefinitionActionSelectionBehavior selectionBehavior?;
    r5:Range timingRange?;
    ComputablePlanDefinitionActionPrecheckBehavior precheckBehavior?;
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActionInput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ComputablePlanDefinitionActionInput record {|
    *r5:BackboneElement;
...
public enum ComputablePlanDefinitionActionPrecheckBehavior {
   CODE_PRECHECKBEHAVIOR_NO = "no",
   CODE_PRECHECKBEHAVIOR_YES = "yes"
}

# ComputablePlanDefinitionActionCardinalityBehavior enum
public enum ComputablePlanDefinitionActionCardinalityBehavior {
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionGoal",
    baseType: (),
    elements: {
        "addresses": {
            name: "addresses",
        ...
        "target": {
            name: "target",
            dataType: ComputablePlanDefinitionGoalTarget,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ComputablePlanDefinitionGoal record {|
    *r5:BackboneElement;
    ...
    ComputablePlanDefinitionGoalTarget[] target?;
|};

# ComputablePlanDefinitionStatus enum
public enum ComputablePlanDefinitionStatus {
...
public enum ComputablePlanDefinitionActionPriority {
...
public enum ComputablePlanDefinitionActionConditionKind {
   CODE_KIND_STOP = "stop",
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActionDynamicValue",
    baseType: (),
    elements: {
        "path": {
            name: "path",
...
public type ComputablePlanDefinitionActionDynamicValue record {|
    *r5:BackboneElement;
...
public enum ComputablePlanDefinitionActionRelatedActionEndRelationship {
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActionRelatedAction",
    baseType: (),
    elements: {
        ...
        "endRelationship": {
            ...
            dataType: ComputablePlanDefinitionActionRelatedActionEndRelationship,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "relationship": {
            name: "relationship",
            dataType: ComputablePlanDefinitionActionRelatedActionRelationship,
            min: 1,
            max: 1,
            isArray: false,
...
public type ComputablePlanDefinitionActionRelatedAction record {|
    *r5:BackboneElement;
    ...
    r5:id targetId;
    r5:Extension[] modifierExtension?;
    ComputablePlanDefinitionActionRelatedActionEndRelationship endRelationship?;
    string id?;
    ComputablePlanDefinitionActionRelatedActionRelationship relationship;
|};
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionGoalTarget",
    baseType: (),
    elements: {
        "detailPlanDefinitionCodeableConcept": {
...
public type ComputablePlanDefinitionGoalTarget record {|
    *r5:BackboneElement;
...
public enum ComputablePlanDefinitionActionRequiredBehavior {
...
# + 'type - The type of participant in the action.
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActorOption",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: ComputablePlanDefinitionActorOptionType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type ComputablePlanDefinitionActorOption record {|
    *r5:BackboneElement;
    ...
    r5:Reference typeReference?;
    string id?;
    ComputablePlanDefinitionActorOptionType 'type?;
|};
...
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActor",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "option": {
            name: "option",
            dataType: ComputablePlanDefinitionActorOption,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ComputablePlanDefinitionActor record {|
    *r5:BackboneElement;
    ...
    ComputablePlanDefinitionActorOption[] option;
|};

# ComputablePlanDefinitionActionSelectionBehavior enum
public enum ComputablePlanDefinitionActionSelectionBehavior {
...
public enum ComputablePlanDefinitionActionRelatedActionRelationship {
...
# + title - A human-readable label for the data requirement used to label data flows in BPMN or similar diagrams. Also provides a human readable label when rendering the data requirement that conveys its purpose to human readers.
@r5:DataTypeDefinition {
    name: "ComputablePlanDefinitionActionOutput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ComputablePlanDefinitionActionOutput record {|
    *r5:BackboneElement;
