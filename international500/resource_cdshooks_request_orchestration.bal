...
public const string PROFILE_BASE_CDSHOOKSREQUESTORCHESTRATION = "http://hl7.org/fhir/StructureDefinition/cdshooksrequestorchestration";
public const RESOURCE_NAME_CDSHOOKSREQUESTORCHESTRATION = "RequestOrchestration";
...
@r5:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/StructureDefinition/cdshooksrequestorchestration",
    elements: {
        "note" : {
            name: "note",
        ...
        "action" : {
            name: "action",
            dataType: CDSHooksRequestOrchestrationAction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority" : {
            name: "priority",
            dataType: CDSHooksRequestOrchestrationPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "intent" : {
            name: "intent",
            dataType: CDSHooksRequestOrchestrationIntent,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "status" : {
            name: "status",
            dataType: CDSHooksRequestOrchestrationStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type CDSHooksRequestOrchestration record {|
    *r5:DomainResource;

    RESOURCE_NAME_CDSHOOKSREQUESTORCHESTRATION resourceType = RESOURCE_NAME_CDSHOOKSREQUESTORCHESTRATION;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.RequestOrchestration.instantiatesUri constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.RequestOrchestration.instantiatesUri constraint. This field must be an array containing at most one item."
        }
    }
    r5:uri[] instantiatesUri;
    CDSHooksRequestOrchestrationAction[] action?;
    string id?;
    r5:Narrative text?;
    ...
    @constraint:Array {
        minLength: {
            value: 1,
            message: "Validation failed for $.RequestOrchestration.identifier constraint. This field must be an array containing at least one item."
        },
        maxLength: {
            value: 1,
            message: "Validation failed for $.RequestOrchestration.identifier constraint. This field must be an array containing at most one item."
        }
    }
    ...
    CDSHooksRequestOrchestrationPriority priority?;
    CDSHooksRequestOrchestrationIntent intent;
    r5:Resource[] contained?;
    r5:Meta meta?;
    r5:uri implicitRules?;
    r5:Identifier groupIdentifier?;
    CDSHooksRequestOrchestrationStatus status;
    r5:Element ...;
|};

# CDSHooksRequestOrchestrationIntent enum
public enum CDSHooksRequestOrchestrationIntent {
...
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationActionDynamicValue",
    baseType: (),
    elements: {
        "path": {
            name: "path",
...
public type CDSHooksRequestOrchestrationActionDynamicValue record {|
    *r5:BackboneElement;
...
public enum CDSHooksRequestOrchestrationActionPrecheckBehavior {
...
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationActionParticipant",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: CDSHooksRequestOrchestrationActionParticipantType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type CDSHooksRequestOrchestrationActionParticipant record {|
    *r5:BackboneElement;
    ...
    string id?;
    CDSHooksRequestOrchestrationActionParticipantType 'type?;
|};

# CDSHooksRequestOrchestrationActionGroupingBehavior enum
public enum CDSHooksRequestOrchestrationActionGroupingBehavior {
...
public enum CDSHooksRequestOrchestrationActionRelatedActionEndRelationship {
...
public enum CDSHooksRequestOrchestrationStatus {
...
public enum CDSHooksRequestOrchestrationActionCardinalityBehavior {
...
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationActionRelatedAction",
    baseType: (),
    elements: {
        ...
        "endRelationship": {
            ...
            dataType: CDSHooksRequestOrchestrationActionRelatedActionEndRelationship,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "relationship": {
            name: "relationship",
            dataType: CDSHooksRequestOrchestrationActionRelatedActionRelationship,
            min: 1,
            max: 1,
            isArray: false,
...
public type CDSHooksRequestOrchestrationActionRelatedAction record {|
    *r5:BackboneElement;
    ...
    r5:id targetId;
    r5:Extension[] modifierExtension?;
    CDSHooksRequestOrchestrationActionRelatedActionEndRelationship endRelationship?;
    r5:Duration offsetRequestOrchestrationDuration?;
    string id?;
    CDSHooksRequestOrchestrationActionRelatedActionRelationship relationship;
|};
...
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationAction",
    baseType: (),
    elements: {
        "cardinalityBehavior": {
            name: "cardinalityBehavior",
            dataType: CDSHooksRequestOrchestrationActionCardinalityBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "groupingBehavior": {
            ...
            dataType: CDSHooksRequestOrchestrationActionGroupingBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "participant": {
            name: "participant",
            dataType: CDSHooksRequestOrchestrationActionParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "output": {
            name: "output",
            dataType: CDSHooksRequestOrchestrationActionOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "dynamicValue": {
            name: "dynamicValue",
            dataType: CDSHooksRequestOrchestrationActionDynamicValue,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relatedAction": {
            name: "relatedAction",
            dataType: CDSHooksRequestOrchestrationActionRelatedAction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority": {
            name: "priority",
            dataType: CDSHooksRequestOrchestrationActionPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "input": {
            name: "input",
            dataType: CDSHooksRequestOrchestrationActionInput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "requiredBehavior": {
            ...
            dataType: CDSHooksRequestOrchestrationActionRequiredBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "condition": {
            name: "condition",
            dataType: CDSHooksRequestOrchestrationActionCondition,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "selectionBehavior": {
            ...
            dataType: CDSHooksRequestOrchestrationActionSelectionBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "precheckBehavior": {
            ...
            dataType: CDSHooksRequestOrchestrationActionPrecheckBehavior,
            min: 0,
            max: 1,
            isArray: false,
...
public type CDSHooksRequestOrchestrationAction record {|
    *r5:BackboneElement;

    CDSHooksRequestOrchestrationActionCardinalityBehavior cardinalityBehavior?;
    ...
    CDSHooksRequestOrchestrationActionGroupingBehavior groupingBehavior?;
    CDSHooksRequestOrchestrationActionParticipant[] participant?;
    CDSHooksRequestOrchestrationActionOutput[] output?;
    r5:canonical transform?;
    CDSHooksRequestOrchestrationActionDynamicValue[] dynamicValue?;
    r5:Age timingAge?;
    string id?;
    CDSHooksRequestOrchestrationActionRelatedAction[] relatedAction?;
    ...
    CDSHooksRequestOrchestrationActionPriority priority?;
    CDSHooksRequestOrchestrationActionInput[] input?;
    CDSHooksRequestOrchestrationActionRequiredBehavior requiredBehavior?;
    CDSHooksRequestOrchestrationActionCondition[] condition?;
    string linkId?;
    CDSHooksRequestOrchestrationActionSelectionBehavior selectionBehavior?;
    r5:Range timingRange?;
    CDSHooksRequestOrchestrationActionPrecheckBehavior precheckBehavior?;
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationActionCondition",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "kind": {
            name: "kind",
            dataType: CDSHooksRequestOrchestrationActionConditionKind,
            min: 1,
            max: 1,
            isArray: false,
...
public type CDSHooksRequestOrchestrationActionCondition record {|
    *r5:BackboneElement;

    r5:Extension[] extension?;
    r5:Expression expression?;
    CDSHooksRequestOrchestrationActionConditionKind kind;
    r5:Extension[] modifierExtension?;
    string id?;
|};

# CDSHooksRequestOrchestrationActionRequiredBehavior enum
public enum CDSHooksRequestOrchestrationActionRequiredBehavior {
...
public enum CDSHooksRequestOrchestrationActionConditionKind {
   CODE_KIND_STOP = "stop",
...
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationActionInput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type CDSHooksRequestOrchestrationActionInput record {|
    *r5:BackboneElement;
...
public enum CDSHooksRequestOrchestrationActionRelatedActionRelationship {
...
# + title - A human-readable label for the data requirement used to label data flows in BPMN or similar diagrams. Also provides a human readable label when rendering the data requirement that conveys its purpose to human readers.
@r5:DataTypeDefinition {
    name: "CDSHooksRequestOrchestrationActionOutput",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type CDSHooksRequestOrchestrationActionOutput record {|
    *r5:BackboneElement;
...
public enum CDSHooksRequestOrchestrationActionPriority {
...
public enum CDSHooksRequestOrchestrationPriority {
   CODE_PRIORITY_STAT = "stat",
   CODE_PRIORITY_ROUTINE = "routine",
   CODE_PRIORITY_URGENT = "urgent",
   CODE_PRIORITY_ASAP = "asap"
...
public enum CDSHooksRequestOrchestrationActionParticipantType {
...
public enum CDSHooksRequestOrchestrationActionSelectionBehavior {
