...
public const string PROFILE_BASE_OBSERVATIONBP = "http://hl7.org/fhir/StructureDefinition/bp";
public const RESOURCE_NAME_OBSERVATIONBP = "Observation";

# FHIR Observationbp resource record.
#
...
# * component Slicings
# 1) ObservationbpComponentDiastolicBP: Used when reporting systolic and diastolic blood pressure.
#       - min = 1
#       - max = 1
#
# 2) ObservationbpComponentSystolicBP: Used when reporting systolic and diastolic blood pressure.
#       - min = 1
#       - max = 1
#
...
# * category Slicings
# 1) ObservationbpCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationbpReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "component" : {
            name: "component",
            dataType: ObservationbpComponent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationbpTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationbp record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONBP resourceType = RESOURCE_NAME_OBSERVATIONBP;
    ...
    ObservationbpReferenceRange[] referenceRange?;
    ...
    r5:Reference device?;
    ObservationbpStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationbpCode code;
    ...
    @constraint:Array {
        ...
        maxLength: {
            value: 1,
            message: "Validation failed for $.Observation.component constraint. This field must be an array containing at most one item."
        }
    }
    ObservationbpComponent[] component;
    ...
    ObservationbpTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# FHIR ObservationbpCode datatype record.
#
...
public type ObservationbpCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationbpReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbpReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbpReferenceRange record {|
    *r5:BackboneElement;
...
public enum ObservationbpStatus {
...
# FHIR ObservationbpTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: ObservationbpTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationbpTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationbpTriggeredByType 'type;
|};

# FHIR ObservationbpComponentDiastolicBP datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbpComponentDiastolicBP",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: ObservationbpComponentCode,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationbpComponentDiastolicBP record {|
    *ObservationbpComponent;

    boolean valueBoolean?;
    r5:CodeableConcept dataAbsentReason?;
    r5:Extension[] extension?;
    r5:time valueTime?;
    ObservationbpComponentCode code;
    r5:Reference valueReference?;
    r5:Range valueRange?;
    r5:Extension[] modifierExtension?;
    r5:CodeableConcept valueCodeableConcept?;
...
# FHIR ObservationbpComponentCodeOne datatype record.
#
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationbpComponentCodeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type ObservationbpComponentCodeOne record {|
    *r5:CodeableConcept;
...
# FHIR ObservationbpComponentSystolicBP datatype record.
#
# + valueBoolean - Vital Sign Value.
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + valueQuantity - Vital Sign Value.
@r5:DataTypeDefinition {
    name: "ObservationbpComponentSystolicBP",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
        ...
        "code": {
            name: "code",
            dataType: ObservationbpComponentCodeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Describes what was observed. Sometimes this is called the observation 'code'.",
...
public type ObservationbpComponentSystolicBP record {|
    *ObservationbpComponent;
    ...
    r5:Extension[] extension?;
    r5:time valueTime?;
    ObservationbpComponentCodeOne code;
    r5:Reference valueReference?;
    r5:Range valueRange?;
    r5:Extension[] modifierExtension?;
    r5:CodeableConcept valueCodeableConcept?;
...
# FHIR ObservationbpComponentCode datatype record.
#
...
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationbpComponentCode",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
...
public type ObservationbpComponentCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationbpCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbpCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbpCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationbpComponent datatype record.
#
# + valueBoolean - Vital Sign Value.
# + dataAbsentReason - Provides a reason why the expected value in the element Observation.component.value[x] is missing.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
public type ObservationbpComponent record {|
    *r5:BackboneElement;
...
# FHIR ObservationbpCategoryVSCat datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + text - A human language representation of the concept as seen/selected/uttered by the user who entered the data and/or which represents the intended meaning of the user.
@r5:DataTypeDefinition {
    name: "ObservationbpCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationbpCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type ObservationbpCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationbpCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum ObservationbpTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationbpCodeCodingBPCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationbpCodeCodingBPCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbpCodeCodingBPCode record {|
    *r5:Coding;

    r5:Extension[] extension?;
    r5:code code = "85354-9";
