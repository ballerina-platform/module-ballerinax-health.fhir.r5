...
public type PlanDefinition record {|
    *r5:DomainResource;

    RESOURCE_NAME_PLANDEFINITION resourceType = RESOURCE_NAME_PLANDEFINITION;
...
public enum PlanDefinitionActionParticipantType {
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "target": {
            name: "target",
            dataType: PlanDefinitionGoalTarget,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlanDefinitionGoal record {|
    *r5:BackboneElement;
...
# FHIR PlanDefinitionActor datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "option": {
            name: "option",
            dataType: PlanDefinitionActorOption,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PlanDefinitionActor record {|
    *r5:BackboneElement;
    ...
    PlanDefinitionActorOption[] option;
|};

# PlanDefinitionActionRelatedActionEndRelationship enum
public enum PlanDefinitionActionRelatedActionEndRelationship {
...
public type PlanDefinitionActionDynamicValue record {|
    *r5:BackboneElement;
...
public enum PlanDefinitionActionGroupingBehavior {
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "endRelationship": {
            ...
            dataType: PlanDefinitionActionRelatedActionEndRelationship,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "relationship": {
            name: "relationship",
            dataType: PlanDefinitionActionRelatedActionRelationship,
            min: 1,
            max: 1,
            isArray: false,
...
public type PlanDefinitionActionRelatedAction record {|
    *r5:BackboneElement;
    ...
    r5:id targetId;
    r5:Extension[] modifierExtension?;
    PlanDefinitionActionRelatedActionEndRelationship endRelationship?;
    string id?;
    PlanDefinitionActionRelatedActionRelationship relationship;
|};

# PlanDefinitionActionConditionKind enum
public enum PlanDefinitionActionConditionKind {
   CODE_KIND_STOP = "stop",
...
public enum PlanDefinitionActionRelatedActionRelationship {
...
# FHIR PlanDefinitionActorOption datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: PlanDefinitionActorOptionType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type PlanDefinitionActorOption record {|
    *r5:BackboneElement;
    ...
    string id?;
    PlanDefinitionActorOptionType 'type?;
|};
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "cardinalityBehavior": {
            ...
            dataType: PlanDefinitionActionCardinalityBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "groupingBehavior": {
            ...
            dataType: PlanDefinitionActionGroupingBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "participant": {
            name: "participant",
            dataType: PlanDefinitionActionParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "output": {
            name: "output",
            dataType: PlanDefinitionActionOutput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "dynamicValue": {
            name: "dynamicValue",
            dataType: PlanDefinitionActionDynamicValue,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relatedAction": {
            name: "relatedAction",
            dataType: PlanDefinitionActionRelatedAction,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "priority": {
            name: "priority",
            dataType: PlanDefinitionActionPriority,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "input": {
            name: "input",
            dataType: PlanDefinitionActionInput,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "requiredBehavior": {
            ...
            dataType: PlanDefinitionActionRequiredBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "condition": {
            name: "condition",
            dataType: PlanDefinitionActionCondition,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "selectionBehavior": {
            ...
            dataType: PlanDefinitionActionSelectionBehavior,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "precheckBehavior": {
            ...
            dataType: PlanDefinitionActionPrecheckBehavior,
            min: 0,
            max: 1,
            isArray: false,
...
public type PlanDefinitionAction record {|
    *r5:BackboneElement;
...
# FHIR PlanDefinitionActionOutput datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
public type PlanDefinitionActionOutput record {|
    *r5:BackboneElement;
...
public enum PlanDefinitionActionPriority {
...
public enum PlanDefinitionActionSelectionBehavior {
...
public enum PlanDefinitionActionRequiredBehavior {
...
public enum PlanDefinitionActionCardinalityBehavior {
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: PlanDefinitionActionParticipantType,
            min: 0,
            max: 1,
            isArray: false,
            description: "The type of participant in the action.",
...
public type PlanDefinitionActionParticipant record {|
    *r5:BackboneElement;
    ...
    r5:Reference typeReference?;
    string id?;
    PlanDefinitionActionParticipantType 'type?;
|};
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "kind": {
            name: "kind",
            dataType: PlanDefinitionActionConditionKind,
            min: 1,
            max: 1,
            isArray: false,
...
public type PlanDefinitionActionCondition record {|
    *r5:BackboneElement;

    r5:Extension[] extension?;
    r5:Expression expression?;
    PlanDefinitionActionConditionKind kind;
    r5:Extension[] modifierExtension?;
    string id?;
|};

# PlanDefinitionActorOptionType enum
public enum PlanDefinitionActorOptionType {
   CODE_TYPE_CARETEAM = "careteam",
   CODE_TYPE_PRACTITIONER = "practitioner",
   CODE_TYPE_PRACTITIONERROLE = "practitionerrole",
   CODE_TYPE_PATIENT = "patient",
...
# FHIR PlanDefinitionActionInput datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
...
public type PlanDefinitionActionInput record {|
    *r5:BackboneElement;
...
public enum PlanDefinitionActionPrecheckBehavior {
