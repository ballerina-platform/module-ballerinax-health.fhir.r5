...
public type Medication record {|
    *r5:DomainResource;
    ...
    r5:Reference marketingAuthorizationHolder?;
    r5:Meta meta?;
...
public type MedicationIngredient record {|
    *r5:BackboneElement;
    ...
    r5:Ratio strengthRatio?;
    r5:Quantity strengthQuantity?;
    r5:Extension[] modifierExtension?;
    r5:CodeableConcept strengthCodeableConcept?;
    string id?;
    boolean isActive?;
|};
