...
public const string PROFILE_BASE_OBSERVATIONRESPRATE = "http://hl7.org/fhir/StructureDefinition/resprate";
public const RESOURCE_NAME_OBSERVATIONRESPRATE = "Observation";

# FHIR Observationresprate resource record.
#
...
# * category Slicings
# 1) ObservationresprateCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: ObservationresprateValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationresprateReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationresprateStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationresprateCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationresprateComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationresprateTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationresprate record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONRESPRATE resourceType = RESOURCE_NAME_OBSERVATIONRESPRATE;
    ...
    r5:Reference device?;
    ObservationresprateStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationresprateCode code;
    ...
    ObservationresprateComponent[] component?;
    ...
    ObservationresprateTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# FHIR ObservationresprateCategoryCoding datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationresprateCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationresprateCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationresprateComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationresprateComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationresprateComponent record {|
    *r5:BackboneElement;
...
# FHIR ObservationresprateCategoryVSCat datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationresprateCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationresprateCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationresprateCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationresprateCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum ObservationresprateTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationresprateCodeCodingRespRateCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationresprateCodeCodingRespRateCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationresprateCodeCodingRespRateCode record {|
    *r5:Coding;
...
# FHIR ObservationresprateCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type ObservationresprateCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationresprateValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationresprateValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationresprateValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
public enum ObservationresprateValueComparator {
...
# FHIR ObservationresprateReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationresprateReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationresprateReferenceRange record {|
    *r5:BackboneElement;
...
public enum ObservationresprateStatus {
...
# FHIR ObservationresprateTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationresprateTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationresprateTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationresprateTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationresprateTriggeredByType 'type;
|};
