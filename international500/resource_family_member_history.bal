...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "participant" : {
            name: "participant",
            dataType: FamilyMemberHistoryParticipant,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "procedure" : {
            name: "procedure",
            dataType: FamilyMemberHistoryProcedure,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type FamilyMemberHistory record {|
    *r5:DomainResource;
    ...
    FamilyMemberHistoryParticipant[] participant?;
    ...
    r5:date bornDate?;
    FamilyMemberHistoryProcedure[] procedure?;
...
public type FamilyMemberHistoryProcedure record {|
    *r5:BackboneElement;
...
public type FamilyMemberHistoryParticipant record {|
    *r5:BackboneElement;
