...
public const string PROFILE_BASE_SHAREABLENAMINGSYSTEM = "http://hl7.org/fhir/StructureDefinition/shareablenamingsystem";
public const RESOURCE_NAME_SHAREABLENAMINGSYSTEM = "NamingSystem";

# FHIR ShareableNamingSystem resource record.
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "kind" : {
            name: "kind",
            dataType: ShareableNamingSystemKind,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "uniqueId" : {
            name: "uniqueId",
            dataType: ShareableNamingSystemUniqueId,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ShareableNamingSystemStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ShareableNamingSystem record {|
    *r5:DomainResource;

    RESOURCE_NAME_SHAREABLENAMINGSYSTEM resourceType = RESOURCE_NAME_SHAREABLENAMINGSYSTEM;
    ...
    ShareableNamingSystemKind kind;
    ...
    ShareableNamingSystemUniqueId[] uniqueId;
    ShareableNamingSystemStatus status;
    r5:Element ...;
|};

# ShareableNamingSystemKind enum
public enum ShareableNamingSystemKind {
...
public enum ShareableNamingSystemUniqueIdType {
...
public enum ShareableNamingSystemStatus {
...
# FHIR ShareableNamingSystemUniqueId datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ShareableNamingSystemUniqueId",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: ShareableNamingSystemUniqueIdType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ShareableNamingSystemUniqueId record {|
    *r5:BackboneElement;
    ...
    string comment?;
    string id?;
    ShareableNamingSystemUniqueIdType 'type;
    string value;
    boolean preferred?;
|};
