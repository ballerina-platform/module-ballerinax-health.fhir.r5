...
public const string PROFILE_BASE_PUBLISHABLEMEASURE = "http://hl7.org/fhir/StructureDefinition/publishablemeasure";
public const RESOURCE_NAME_PUBLISHABLEMEASURE = "Measure";

# FHIR PublishableMeasure resource record.
#
...
@r5:ResourceDefinition {
    ...
    profile: "http://hl7.org/fhir/StructureDefinition/publishablemeasure",
    elements: {
        "date" : {
            name: "date",
        ...
        "group" : {
            name: "group",
            dataType: PublishableMeasureGroup,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Measure.group"
        ...
        "relatedArtifact" : {
            ...
            dataType: PublishableMeasureRelatedArtifact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "supplementalData" : {
            ...
            dataType: PublishableMeasureSupplementalData,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: PublishableMeasureStatus,
            min: 1,
            max: 1,
            isArray: false,
            path: "Measure.status",
        ...
        "term" : {
            name: "term",
            dataType: PublishableMeasureTerm,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            path: "Measure.term"
...
public type PublishableMeasure record {|
    *r5:DomainResource;

    RESOURCE_NAME_PUBLISHABLEMEASURE resourceType = RESOURCE_NAME_PUBLISHABLEMEASURE;
    ...
    string id?;
    r5:Narrative text?;
    PublishableMeasureGroup[] group?;
    r5:Identifier[] identifier?;
    PublishableMeasureRelatedArtifact[] relatedArtifact?;
    ...
    PublishableMeasureSupplementalData[] supplementalData?;
    r5:code basis?;
    string 'version;
    ...
    PublishableMeasureStatus status;
...
# FHIR PublishableMeasureGroupStratifierComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "PublishableMeasureGroupStratifierComponent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PublishableMeasureGroupStratifierComponent record {|
    *r5:BackboneElement;
...
# FHIR PublishableMeasureGroupStratifier datatype record.
#
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r5:DataTypeDefinition {
    name: "PublishableMeasureGroupStratifier",
    baseType: (),
    elements: {
        "component": {
            name: "component",
            dataType: PublishableMeasureGroupStratifierComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PublishableMeasureGroupStratifier record {|
    *r5:BackboneElement;

    PublishableMeasureGroupStratifierComponent[] component?;
    r5:Extension[] extension?;
    r5:CodeableConcept code?;
    string linkId?;
    r5:Expression criteria?;
...
# FHIR PublishableMeasureGroup datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + scoring - Indicates how the calculation is performed for the measure, including proportion, ratio, continuous-variable, and cohort. The value set is extensible, allowing additional measure scoring types to be represented.
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "population": {
            name: "population",
            dataType: PublishableMeasureGroupPopulation,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "stratifier": {
            name: "stratifier",
            dataType: PublishableMeasureGroupStratifier,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PublishableMeasureGroup record {|
    *r5:BackboneElement;
    ...
    r5:CodeableConcept[] 'type?;
    r5:Reference subjectReference?;
    PublishableMeasureGroupPopulation[] population?;
    r5:canonical[] library?;
    string linkId?;
    PublishableMeasureGroupStratifier[] stratifier?;
    string id?;
    r5:CodeableConcept scoringUnit?;
|};

# FHIR PublishableMeasureGroupPopulation datatype record.
#
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r5:DataTypeDefinition {
    name: "PublishableMeasureGroupPopulation",
    baseType: (),
    elements: {
        "aggregateMethod": {
...
public type PublishableMeasureGroupPopulation record {|
    *r5:BackboneElement;
...
# FHIR PublishableMeasureSupplementalData datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
@r5:DataTypeDefinition {
    name: "PublishableMeasureSupplementalData",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PublishableMeasureSupplementalData record {|
    *r5:BackboneElement;
...
public enum PublishableMeasureRelatedArtifactType {
...
# FHIR PublishableMeasureTerm datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
public type PublishableMeasureTerm record {|
    *r5:BackboneElement;
...
public enum PublishableMeasureStatus {
...
# FHIR PublishableMeasureRelatedArtifact datatype record.
#
...
@r5:DataTypeDefinition {
    name: "PublishableMeasureRelatedArtifact",
    baseType: (),
    elements: {
        "publicationStatus": {
            name: "publicationStatus",
            dataType: PublishableMeasureRelatedArtifactPublicationStatus,
            min: 0,
            max: 1,
            isArray: false,
            description: "The publication status of the artifact being referred to.",
            path: "Measure.relatedArtifact.publicationStatus"
        },
        "extension": {
            name: "extension",
            dataType: r5:Extension,
        ...
        "classifier": {
            ...
            path: "Measure.relatedArtifact.classifier"
        },
        "id": {
            name: "id",
            dataType: string,
        ...
        "type": {
            name: "type",
            dataType: PublishableMeasureRelatedArtifactType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "publicationDate": {
            ...
            path: "Measure.relatedArtifact.publicationDate"
        },
        "resourceReference": {
            ...
            path: "Measure.relatedArtifact.resourceReference"
        }
    },
    serializers: {
        'xml: r5:complexDataTypeXMLSerializer,
...
public type PublishableMeasureRelatedArtifact record {|
    *r5:RelatedArtifact;

    PublishableMeasureRelatedArtifactPublicationStatus publicationStatus?;
    r5:Extension[] extension?;
