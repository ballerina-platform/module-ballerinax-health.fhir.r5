...
public const string PROFILE_BASE_SHAREABLECONCEPTMAP = "http://hl7.org/fhir/StructureDefinition/shareableconceptmap";
public const RESOURCE_NAME_SHAREABLECONCEPTMAP = "ConceptMap";

# FHIR ShareableConceptMap resource record.
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "additionalAttribute" : {
            ...
            dataType: ShareableConceptMapAdditionalAttribute,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "property" : {
            name: "property",
            dataType: ShareableConceptMapProperty,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "group" : {
            name: "group",
            dataType: ShareableConceptMapGroup,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ShareableConceptMapStatus,
            min: 1,
            max: 1,
            isArray: false,
...
public type ShareableConceptMap record {|
    *r5:DomainResource;

    RESOURCE_NAME_SHAREABLECONCEPTMAP resourceType = RESOURCE_NAME_SHAREABLECONCEPTMAP;
    ...
    ShareableConceptMapAdditionalAttribute[] additionalAttribute?;
    string versionAlgorithmString?;
    r5:ContactDetail[] contact?;
    r5:ContactDetail[] endorser?;
    ShareableConceptMapProperty[] property?;
    string id?;
    r5:Narrative text?;
    r5:uri sourceScopeUri?;
    ShareableConceptMapGroup[] group?;
    ...
    ShareableConceptMapStatus status;
    r5:Element ...;
|};

# ShareableConceptMapPropertyType enum
public enum ShareableConceptMapPropertyType {
...
public enum ShareableConceptMapStatus {
...
public enum ShareableConceptMapGroupUnmappedMode {
   CODE_MODE_USE_SOURCE_CODE = "use-source-code",
   CODE_MODE_FIXED = "fixed",
   CODE_MODE_OTHER_MAP = "other-map"
}

# FHIR ShareableConceptMapGroupElementTargetProperty datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapGroupElementTargetProperty",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ShareableConceptMapGroupElementTargetProperty record {|
    *r5:BackboneElement;
...
# FHIR ShareableConceptMapProperty datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapProperty",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: ShareableConceptMapPropertyType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ShareableConceptMapProperty record {|
    *r5:BackboneElement;
    ...
    string description?;
    string id?;
    ShareableConceptMapPropertyType 'type;
    r5:uri uri?;
|};

# FHIR ShareableConceptMapGroup datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "unmapped": {
            name: "unmapped",
            dataType: ShareableConceptMapGroupUnmapped,
            min: 0,
            max: 1,
            isArray: false,
        ...
        "element": {
            name: "element",
            dataType: ShareableConceptMapGroupElement,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ShareableConceptMapGroup record {|
    *r5:BackboneElement;
    ...
    string id?;
    r5:canonical 'source?;
    ShareableConceptMapGroupUnmapped unmapped?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    ShareableConceptMapGroupElement[] element;
    r5:canonical target?;
|};

# FHIR ShareableConceptMapGroupElementTarget datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapGroupElementTarget",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "dependsOn": {
            name: "dependsOn",
            dataType: ShareableConceptMapGroupElementTargetDependsOn,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "property": {
            name: "property",
            dataType: ShareableConceptMapGroupElementTargetProperty,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relationship": {
            name: "relationship",
            dataType: ShareableConceptMapGroupElementTargetRelationship,
            min: 1,
            max: 1,
            isArray: false,
...
public type ShareableConceptMapGroupElementTarget record {|
    *r5:BackboneElement;

    r5:Extension[] extension?;
    r5:code code?;
    r5:canonical valueSet?;
    ShareableConceptMapGroupElementTargetDependsOn[] dependsOn?;
    string display?;
    r5:Extension[] modifierExtension?;
    ShareableConceptMapGroupElementTargetProperty[] property?;
    string comment?;
    string id?;
    ShareableConceptMapGroupElementTargetRelationship relationship;
|};

# ShareableConceptMapAdditionalAttributeType enum
public enum ShareableConceptMapAdditionalAttributeType {
   CODE_TYPE_CODE = "code",
   CODE_TYPE_BOOLEAN = "boolean",
   CODE_TYPE_STRING = "string",
   CODE_TYPE_CODING = "Coding",
...
# FHIR ShareableConceptMapGroupElementTargetDependsOn datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapGroupElementTargetDependsOn",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ShareableConceptMapGroupElementTargetDependsOn record {|
    *r5:BackboneElement;
...
public enum ShareableConceptMapGroupElementTargetRelationship {
...
# FHIR ShareableConceptMapGroupElement datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapGroupElement",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "target": {
            name: "target",
            dataType: ShareableConceptMapGroupElementTarget,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ShareableConceptMapGroupElement record {|
    *r5:BackboneElement;
    ...
    boolean noMap?;
    string id?;
    ShareableConceptMapGroupElementTarget[] target?;
|};

# ShareableConceptMapGroupUnmappedRelationship enum
public enum ShareableConceptMapGroupUnmappedRelationship {
   CODE_RELATIONSHIP_EQUIVALENT = "equivalent",
   CODE_RELATIONSHIP_RELATED_TO = "related-to",
   CODE_RELATIONSHIP_NOT_RELATED_TO = "not-related-to",
   CODE_RELATIONSHIP_SOURCE_IS_NARROWER_THAN_TARGET = "source-is-narrower-than-target",
...
# FHIR ShareableConceptMapGroupUnmapped datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapGroupUnmapped",
    baseType: (),
    elements: {
        "mode": {
            name: "mode",
            dataType: ShareableConceptMapGroupUnmappedMode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "relationship": {
            name: "relationship",
            dataType: ShareableConceptMapGroupUnmappedRelationship,
            min: 0,
            max: 1,
            isArray: false,
...
public type ShareableConceptMapGroupUnmapped record {|
    *r5:BackboneElement;

    ShareableConceptMapGroupUnmappedMode mode;
    r5:Extension[] extension?;
    r5:code code?;
    r5:canonical valueSet?;
    string display?;
    r5:Extension[] modifierExtension?;
    string id?;
    ShareableConceptMapGroupUnmappedRelationship relationship?;
    r5:canonical otherMap?;
|};

# FHIR ShareableConceptMapAdditionalAttribute datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ShareableConceptMapAdditionalAttribute",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: ShareableConceptMapAdditionalAttributeType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ShareableConceptMapAdditionalAttribute record {|
    *r5:BackboneElement;
    ...
    string description?;
    string id?;
    ShareableConceptMapAdditionalAttributeType 'type;
    r5:uri uri?;
|};
