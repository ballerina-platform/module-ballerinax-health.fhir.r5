...
public const string PROFILE_BASE_OBSERVATIONBMI = "http://hl7.org/fhir/StructureDefinition/bmi";
public const RESOURCE_NAME_OBSERVATIONBMI = "Observation";

# FHIR Observationbmi resource record.
#
...
# * category Slicings
# 1) ObservationbmiCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "component" : {
            name: "component",
            dataType: ObservationbmiComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationbmiReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationbmiTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationbmi record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONBMI resourceType = RESOURCE_NAME_OBSERVATIONBMI;
    ...
    ObservationbmiValue valueQuantity;
    ...
    ObservationbmiComponent[] component?;
    r5:Resource[] contained?;
    ObservationbmiReferenceRange[] referenceRange?;
    ...
    r5:Reference device?;
    ObservationbmiStatus status;
    ObservationbmiTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# FHIR ObservationbmiCategoryVSCat datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbmiCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationbmiCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationbmiCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationbmiCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};

# FHIR ObservationbmiComponent datatype record.
#
...
public type ObservationbmiComponent record {|
    *r5:BackboneElement;
...
public enum ObservationbmiStatus {
...
# FHIR ObservationbmiCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbmiCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbmiCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationbmiValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbmiValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationbmiValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
# FHIR ObservationbmiTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbmiTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationbmiTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationbmiTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationbmiTriggeredByType 'type;
|};

# FHIR ObservationbmiCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type ObservationbmiCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationbmiReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbmiReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbmiReferenceRange record {|
    *r5:BackboneElement;
...
public enum ObservationbmiTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationbmiCodeCodingBMICode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationbmiCodeCodingBMICode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbmiCodeCodingBMICode record {|
    *r5:Coding;

    r5:Extension[] extension?;
    r5:code code = "39156-5";
