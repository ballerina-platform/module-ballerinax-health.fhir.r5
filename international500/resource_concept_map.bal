...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "additionalAttribute" : {
            ...
            dataType: ConceptMapAdditionalAttribute,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ConceptMap record {|
    *r5:DomainResource;
    ...
    ConceptMapAdditionalAttribute[] additionalAttribute?;
    string versionAlgorithmString?;
    r5:ContactDetail[] contact?;
    r5:ContactDetail[] endorser?;
    ConceptMapProperty[] property?;
    string id?;
    r5:Narrative text?;
...
public type ConceptMapGroupElementTargetProperty record {|
    *r5:BackboneElement;
...
public enum ConceptMapGroupElementTargetRelationship {
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "relationship": {
            name: "relationship",
            dataType: ConceptMapGroupUnmappedRelationship,
            min: 0,
            max: 1,
            isArray: false,
...
public type ConceptMapGroupUnmapped record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ConceptMapGroupUnmappedRelationship relationship?;
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: ConceptMapPropertyType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ConceptMapProperty record {|
    *r5:BackboneElement;
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: ConceptMapAdditionalAttributeType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ConceptMapAdditionalAttribute record {|
    *r5:BackboneElement;
    ...
    string description?;
    string id?;
    ConceptMapAdditionalAttributeType 'type;
    r5:uri uri?;
|};
...
public enum ConceptMapGroupUnmappedRelationship {
   CODE_RELATIONSHIP_EQUIVALENT = "equivalent",
   CODE_RELATIONSHIP_RELATED_TO = "related-to",
   CODE_RELATIONSHIP_NOT_RELATED_TO = "not-related-to",
   CODE_RELATIONSHIP_SOURCE_IS_NARROWER_THAN_TARGET = "source-is-narrower-than-target",
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "property": {
            name: "property",
            dataType: ConceptMapGroupElementTargetProperty,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "relationship": {
            name: "relationship",
            dataType: ConceptMapGroupElementTargetRelationship,
            min: 1,
            max: 1,
            isArray: false,
...
public type ConceptMapGroupElementTarget record {|
    *r5:BackboneElement;
    ...
    string display?;
    r5:Extension[] modifierExtension?;
    ConceptMapGroupElementTargetProperty[] property?;
    string comment?;
    string id?;
    ConceptMapGroupElementTargetRelationship relationship;
|};
...
public enum ConceptMapAdditionalAttributeType {
   CODE_TYPE_CODE = "code",
   CODE_TYPE_BOOLEAN = "boolean",
   CODE_TYPE_STRING = "string",
   CODE_TYPE_CODING = "Coding",
