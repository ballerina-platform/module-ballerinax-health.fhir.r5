...
public const string PROFILE_BASE_OBSERVATIONBODYTEMP = "http://hl7.org/fhir/StructureDefinition/bodytemp";
public const RESOURCE_NAME_OBSERVATIONBODYTEMP = "Observation";

# FHIR Observationbodytemp resource record.
#
...
# * category Slicings
# 1) ObservationbodytempCategoryVSCat: Classification of type of observation
#       - min = 1
#       - max = 1
#
...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "valueQuantity" : {
            name: "valueQuantity",
            dataType: ObservationbodytempValue,
            min: 0,
            max: 1,
            isArray: false,
            path: "Observation.value[x]"
        ...
        "referenceRange" : {
            name: "referenceRange",
            dataType: ObservationbodytempReferenceRange,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "status" : {
            name: "status",
            dataType: ObservationbodytempStatus,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "code" : {
            name: "code",
            dataType: ObservationbodytempCode,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "component" : {
            name: "component",
            dataType: ObservationbodytempComponent,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "triggeredBy" : {
            name: "triggeredBy",
            dataType: ObservationbodytempTriggeredBy,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type Observationbodytemp record {|
    *r5:DomainResource;

    RESOURCE_NAME_OBSERVATIONBODYTEMP resourceType = RESOURCE_NAME_OBSERVATIONBODYTEMP;
    ...
    r5:Reference device?;
    ObservationbodytempStatus status;
    boolean valueBoolean?;
    r5:Annotation[] note?;
    r5:Extension[] extension?;
    ObservationbodytempCode code;
    ...
    ObservationbodytempComponent[] component?;
    ...
    ObservationbodytempTriggeredBy[] triggeredBy?;
    r5:Element ...;
|};

# FHIR ObservationbodytempCategoryVSCat datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodytempCategoryVSCat",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: ObservationbodytempCategoryCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type ObservationbodytempCategoryVSCat record {|
    *r5:CodeableConcept;
    ...
    ObservationbodytempCategoryCoding[] coding;
    r5:Extension[] extension?;
    string id?;
    string text?;
|};
...
public enum ObservationbodytempStatus {
...
# FHIR ObservationbodytempComponent datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodytempComponent",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type ObservationbodytempComponent record {|
    *r5:BackboneElement;
...
public enum ObservationbodytempValueComparator {
...
# FHIR ObservationbodytempCodeCodingBodyTempCode datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbodytempCodeCodingBodyTempCode",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodytempCodeCodingBodyTempCode record {|
    *r5:Coding;
...
public enum ObservationbodytempTriggeredByType {
   CODE_TYPE_REPEAT = "repeat",
   CODE_TYPE_REFLEX = "reflex",
   CODE_TYPE_RE_RUN = "re-run"
}

# FHIR ObservationbodytempCategoryCoding datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + code - A symbol in syntax defined by the system. The symbol may be a predefined code or an expression in a syntax defined by the coding system (e.g. post-coordination).
# + system - The identification of the code system that defines the meaning of the symbol in the code.
...
# + 'version - The version of the code system which was used when choosing this code. Note that a well-maintained code system does not need the version reported, because the meaning of codes is consistent across versions. However this cannot consistently be assured, and when the meaning is not guaranteed to be consistent, the version SHOULD be exchanged.
@r5:DataTypeDefinition {
    name: "ObservationbodytempCategoryCoding",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodytempCategoryCoding record {|
    *r5:Coding;
...
# FHIR ObservationbodytempReferenceRange datatype record.
#
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
...
@r5:DataTypeDefinition {
    name: "ObservationbodytempReferenceRange",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type ObservationbodytempReferenceRange record {|
    *r5:BackboneElement;
...
# FHIR ObservationbodytempValue datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodytempValue",
    baseType: (),
    elements: {
        "comparator": {
            name: "comparator",
            dataType: ObservationbodytempValueComparator,
            min: 0,
            max: 1,
            isArray: false,
...
# FHIR ObservationbodytempCode datatype record.
#
# + coding - A reference to a code defined by a terminology system.
# + extension - May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and managable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
...
public type ObservationbodytempCode record {|
    *r5:CodeableConcept;
...
# FHIR ObservationbodytempTriggeredBy datatype record.
#
...
@r5:DataTypeDefinition {
    name: "ObservationbodytempTriggeredBy",
    baseType: (),
    elements: {
        "reason": {
            name: "reason",
        ...
        "type": {
            name: "type",
            dataType: ObservationbodytempTriggeredByType,
            min: 1,
            max: 1,
            isArray: false,
...
public type ObservationbodytempTriggeredBy record {|
    *r5:BackboneElement;
    ...
    r5:Extension[] modifierExtension?;
    string id?;
    ObservationbodytempTriggeredByType 'type;
|};
