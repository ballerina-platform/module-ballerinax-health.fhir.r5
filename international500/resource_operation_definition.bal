...
@r5:ResourceDefinition {
    ...
    elements: {
        ...
        "copyright" : {
            ...
            max: 1,
            isArray: false,
            path: "OperationDefinition.copyright"
        },
        "extension" : {
            name: "extension",
        ...
        "versionAlgorithmString" : {
            ...
            max: 1,
            isArray: false,
            path: "OperationDefinition.versionAlgorithm[x]",
        ...
        "copyrightLabel" : {
            ...
            max: 1,
            isArray: false,
            path: "OperationDefinition.copyrightLabel"
        },
        "meta" : {
            name: "meta",
            dataType: r5:Meta,
...
public enum OperationDefinitionParameterScope {
   CODE_SCOPE_INSTANCE = "instance",
   CODE_SCOPE_SYSTEM = "system",
   CODE_SCOPE_TYPE = "type"
}
...
@r5:DataTypeDefinition {
    ...
    elements: {
        ...
        "allowedType": {
            ...
            path: "OperationDefinition.parameter.allowedType"
        },
        "referencedFrom": {
            name: "referencedFrom",
...
public type OperationDefinitionParameter record {|
    *r5:BackboneElement;
    ...
    r5:integer min;
    OperationDefinitionParameterScope[] scope?;
    r5:code name;
