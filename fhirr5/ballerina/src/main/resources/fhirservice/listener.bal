...
public isolated class Listener {
    ...
    private final r5:ResourceAPIConfig config;
    private http:Service httpService = isolated service object {};

    public isolated function init(int? port = (), r5:ResourceAPIConfig config = {operations: [], authzConfig: (), profiles: [], defaultProfile: (), searchParameters: [], serverConfig: (), resourceType: ""}) returns error? {
