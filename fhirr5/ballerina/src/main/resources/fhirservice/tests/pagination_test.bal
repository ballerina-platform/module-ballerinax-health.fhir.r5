...
function testDefaultPageParams() returns error? {
    [map<r5:RequestSearchParameter[]>, r5:PaginationContext] params = check fhirPaginationClient->/test1/Patient();
...
function testCustomPageParam() returns error? {
    [map<r5:RequestSearchParameter[]>, r5:PaginationContext] params = check fhirPaginationClient->/test1/Patient(page = 2);
...
function testCustomCountParam() returns error? {
    [map<r5:RequestSearchParameter[]>, r5:PaginationContext] params = check fhirPaginationClient->/test1/Patient(_count = 5);
    test:assertEquals(params[1].page, 1);
...
function testPageWithOtherQparams() returns error? {
    [map<r5:RequestSearchParameter[]>, r5:PaginationContext] params = check fhirPaginationClient->/test1/Patient(page = 2, given = "Vijay");
...
function testAllLinks() returns error? {
    r5:Bundle patients = check fhirPaginationClient->/test2/Patient(page = 2, given = "Vijay");
    r5:BundleLink[]? allLinks = patients.link;
    string nextLink = "";
    string prevLink = "";
    string selfLink = "";
    if allLinks is r5:BundleLink[] {
        foreach r5:BundleLink link in allLinks {
            match link.relation {
                "next" => {
                    nextLink = link.url;
                }
...
function testAllLinksWithCount() returns error? {
    r5:Bundle patients = check fhirPaginationClient->/test2/Patient(page = 2, _count = 5, given = "Vijay");
    r5:BundleLink[]? allLinks = patients.link;
    string nextLink = "";
    string prevLink = "";
    string selfLink = "";
...
function testAllLinksWithPage() returns error? {
    r5:Bundle patients = check fhirPaginationClient->/test2/Patient(_count = 2, given = "Vijay");
    r5:BundleLink[]? allLinks = patients.link;
    string nextLink = "";
    string prevLink = "";
    string selfLink = "";
...
function testNoPrev() returns error? {
    r5:Bundle patients = check fhirPaginationClient->/test2/Patient(page = 1, given = "Vijay");
    r5:BundleLink[]? allLinks = patients.link;
    string nextLink = "";
    string prevLink = "";
    string selfLink = "";
...
function testNext() returns error? {
    r5:Bundle patients = check fhirPaginationClient->/test3/Patient;
    r5:BundleLink[]? allLinks = patients.link;
    string nextLink = "";
    string prevLink = "";
    string selfLink = "";
...
function testNoPagination() returns error? {
    ...
    test:assertTrue(opOutcome is r5:OperationOutcome);
    if opOutcome is r5:OperationOutcome {
        r5:CodeableConcept? details = opOutcome.issue[0].details;
