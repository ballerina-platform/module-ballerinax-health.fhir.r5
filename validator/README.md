...
import ballerinax/health.fhir.r5.validator;
...
public function main() returns error? {
    ...
    r5:FHIRValidationError? validateFHIRResourceJson = validator:validate(body);

    if validateFHIRResourceJson is r5:FHIRValidationError {
...
public function main() returns error? {
    ...
    r5:FHIRValidationError? validateFHIRResourceJson = validator:validate(body, international500:Patient);
...
terminologyServiceApi="http://localhost:9089/fhir/r5"
tokenUrl=""
clientId=""
clientSecret=""
```
...
- `terminologyServiceApi`: The endpoint of your FHIR R5 terminology service.
